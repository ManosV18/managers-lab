def run_stage2():
    ...
    with col2:
        ...
        slow_moving_pct = st.slider("Slow-Moving / Buffer Stock (%)", 0, 100, 20, help="Percentage of inventory that is not fast-turning and requires permanent financing.")
    ...
    if drain > op_profit and op_profit > 0:
        st.error(f"🚨 **Liquidity Trap:** Your slow-moving inventory and credit terms are consuming {(drain/op_profit)*100:.1f}% of your operating profit. You are growing yourself into bankruptcy.")
    elif op_profit <= 0:
