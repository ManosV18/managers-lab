...
def run_stage1():
    ...
    fig = go.Figure()
    fig.add_trace(go.Scatter(x=x_vals, y=revenue_line, name="Total Revenue"))
    fig.add_trace(go.Scatter(x=x_vals, y=operating_cost_line, name="Operating Cost Line"))
    fig.add_vline(x=operating_bep, line_dash="dash", annotation_text="Operating BEP")
    fig.add_vline(x=survival_bep, line_dash="dot", annotation_text="Survival BEP")
    fig.update_layout(title="Break-Even Structure", xaxis_title="Units", yaxis_title="Euros")
