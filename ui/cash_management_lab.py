...
def render_cash_management_lab(
    ...
    The UI intentionally remains simple and focused on the
    six-month cash position.
    """
    ...
    if baseline_state is None:
        st.warning(
            "No CompanyState is available to create the cash forecast."
        )
        return
    ...
    with col1:
        ...
        monthly_opex = st.number_input(
            ...
            step=1000.0,
            key="cash_monthly_opex",
            help=(
                "The default is based on the company's average "
                "operating expenses. Change it if you want to "
                "use a different monthly amount."
            ),
        )
    ...
    with col2:
        ...
        monthly_debt = st.number_input(
            ...
            step=1000.0,
            key="cash_monthly_debt",
            help=(
                "Enter one total monthly amount for all loans, "
