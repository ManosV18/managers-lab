...
""")
    ...
    with st.form("discount_impact_form"):
        ...
        with col2:
            ...
            st.caption("Current sales of suits as % of previous period. Adjust to see how far you are from required increase.")
    ...
    if submitted:
        ...
        if result is None:
            ...
            # Show vertical bar plot including current sales
            plot_required_sales_increase(result, current_sales_pct)
