# ==========================================
# ⚖️ LOAN VS LEASING - COMPLETE ANALYTICAL TOOL
# ==========================================

# 1. Βοηθητική συνάρτηση PMT (για να μην χρειάζεσαι εξωτερικές βιβλιοθήκες)
...
# 2. Formatter για Ευρώ
def format_eur(x):
    return f"€ {x:,.0f}".replace(",", ".")

# 3. Η Κεντρική Μηχανή Υπολογισμού (Η δική σου μεθοδολογία)
...
# 4. Το UI της συνάρτησης που καλεί το Registry
def loan_vs_leasing_ui():
    ...
    with col1:
        ...
        # Εδώ μπαίνει αυτόματα ο συντελεστής από το κεντρικό μενού
    ...
    # Sensitivity Chart (Όπως τον είχες)
